...
//	@GetMapping("/")
	 ...
	 * HttpSession session) { //login.jsp에서 보낸 아이디와 암호를 받아서 sysout으로 출력 String id =
	...
	public String login(@RequestParam(name = "id", defaultValue = "user", required = true)String id, 
			@RequestParam(name = "pass", defaultValue = "password", required = true) String pass, HttpSession session) {
